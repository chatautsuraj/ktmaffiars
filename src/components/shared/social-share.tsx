...
export function SocialShare({ title, url }: SocialShareProps) {
  ...
  const shareLinks = [
    { icon: XIcon, label: "X", href: `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}` },
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-xs text-muted uppercase tracking-wider mr-2">Share</span>
